...
#    Updated: 2021/03/19 13:28:07 by lburnet          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRCS_MATHS	=	conversions.c plane3d.c rotation3d.c some_calc.c some_calc3d.c sphere3d.c triangle3d.c square3d.c cylinder3d.c init_t_vec3.c
